             ...
             <div class="row">
              <div class="col-sm-6">
                <div class="form-group">
                  <label class="control-label" for="nom" >Type<span class="text-danger">*</span></label>
                  <input type="text" placeholder="type..." name="nom" id="nom" class="form-control" value="" required="required">
                </div>
              ...
              <div class="col-sm-6">
                <div class="form-group">
                  <label class="control-label" for="poste" >Lieu<span class="text-danger">*</span></label>
                  <input type="text" placeholder="lieu..." name="poste" id="poste" value="" class="form-control" required="required">
                </div>
...
if ($run) {
   ...
   echo "<script>window.open('listecap.php','_self')</script>";
